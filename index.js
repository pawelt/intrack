...
`,Ue;g(I("migration-export:click"),()=>{let e=he(),t=X();Q(Ue,JSON.stringify({instruments:t,wallets:e},null,2)),Ue.select()});g(I("migration-import:click"),async()=>{if(!!confirm("WARNING! This will replace *ALL* INSTRUMENT AND WALLET  data in local storage!"))try{let{wallets:e,instruments:t}=JSON.parse(Z(Ue,""));console.log({wallets:e,instruments:t}),await Et(t),await Ot(e),y(U,{})}catch(e){alert("Failed to load data: "+e)}});var Nr=()=>{let e=o("div",{class:xn},o("div",null,o(D,{xname:"migration-export"},"Export from LS")," ",o(D,{xname:"migration-import"},"Import to LS")),o("textarea",{xname:"buffer"}));return e.onMount=()=>{Ue=S({xname:"buffer"}),console.log("ViewMigration mounted!")},e};var _e={home:{label:"Home",Component:hr},wallets:{label:"Wallets",Component:Cr},instruments:{label:"Instruments",Component:vr},todo:{label:"Todo",Component:kr},migration:{label:"Data migration",Component:Nr}},be=()=>new URLSearchParams(window.location.search).get("view")||"home",Lr=()=>{let{Component:e,label:t}=_e[be()]||_e.home;return{Component:e,label:t}};var wn=_`
  -label: top-bar;
